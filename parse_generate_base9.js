...
app_script2 = app_script2+'		if (S(msg).include(\'ZWave\') && (!S(msg).include(\'ZWAVE\')) && S(msg).include(\'Battery level\') && (!S(msg).include(\'_ON\')) && (!S(msg).include(\'_OFF\')) && !(S(msg).include(\'Power Measure\')))\n';
app_script2 = app_script2+'		{\n';
				...
				*/
				...
				else if (proto =="ZWAVE")
				{
					...
					if (type_eqp == "receiverXDom")
					{
						...
						app_zwave = app_zwave+'\n		else if (zwave_id=="'+id_eqp+'" && zwave_status=="UNKNOWN" && dev == "WakeUp")\n'
						app_zwave = app_zwave+'		{\n';
