...
app_script2 = app_script2+'	if (bat == "OK" || bat == "Ok") { bat_bool = 1}\n';
...
app_script2 = app_script2+'			if ((S(msg).include("ZWave")))	//Sent radio ID (1 Burst(s), Protocols=\'ZWave n38\'  Last RF Transmit Time=20ms): ZC7_ON\n';
...
app_script2 = app_script2+'			//Test pour identifier le composant ZWAVE impacte\n';
app_script2 = app_script2+'			if ((S(msg).include("ZWave")))	//Sent radio ID (1 Burst(s), Protocols=\'ZWave n38\'  Last RF Transmit Time=20ms): ZC7_OFF\n';
...
/*app_script2 = app_script2+'	//Test de remontees de composants Inter/shutter RFY433 ou SOMFY		 Sent radio ID (1 Burst(s), Protocols=\'Inter/shutter RFY433\' ): C1_OFF\n';
app_script2 = app_script2+'	somfy = S(msg).include(\'Inter/shutter RFY433\'); somfy_id = ""; somfy_power_ON = ""; somfy_power_OFF = ""; somfy_DIM_SPECIAL = "";\n ';
app_script2 = app_script2+'	if (S(msg).include(\'Inter/shutter RFY433\'))\n';
app_script2 = app_script2+'	{\n';
app_script2 = app_script2+'		somfy = true;\n';
app_script2 = app_script2+'		somfy_id 			= S(msg).between("Protocols=\'Inter/shutter RFY433\' ): ", " ").s;\n';
app_script2 = app_script2+'		somfy_power_ON 		= S(msg).include(\'_ON\');\n';
app_script2 = app_script2+'		somfy_power_OFF 	= S(msg).include(\'_OFF\');\n';
app_script2 = app_script2+'		somfy_DIM_SPECIAL 	= S(msg).include(\'DIM/SPECIAL\');\n';
app_script2 = app_script2+'		//somfy_cmd 			= S(msg).between("Protocols=\'Inter/shutter RFY433\' ): ", " ").s;\n';
app_script2 = app_script2+'		console.log("Debug : somfy     : " + somfy + " | Power ON : " + somfy_power_ON + " | Power OFF : " + somfy_power_OFF + " | DIM/SPECIAL : " + somfy_DIM_SPECIAL);\n';
app_script2 = app_script2+'	}\n';*/
...
app_script2 = app_script2+'		console.log("Debug : xdd868pilotwire    : " + xdd868pilotwire + " | Composant/Id " + xdd868pilotwire_id + " | Statut " + xdd868pilotwire_status);\n';
app_script2 = app_script2+'	}\n';
...
request(xmlurl, function(err, resp, body)
{
	...
	parseString(body, function(err, result)
	{
			...
			else
			{
				...
				*/
				...
				if (proto =="DOMIA")
				{
					//A implémenter
					console.log(" Equipement de type "+proto+" | Tests non realises en l absence de ce type d equipement\n");
					app_domia=app_domia+'	//Aucun equipement VISIONIC433 n est en ma possession pour tester et remonter les infos\n';
				...
				if (proto =="RF X10")
				{
					...
					jid_descr = jid_descr+'var '+jid+' = require(\'string\');\n';
					jid_file = jid_file+'\t'+jid+' = 42;\t//'+periph_jeedom+';\n';
					periph_file = periph_file+type_eqp+'\t'+periph_jeedom+'\t'+id_eqp+'\n';
					...
					app_rfx10 = app_rfx10+'			http_request = \"http://'+jeedom_ip+jeedom_chemin+jeedom_api+'&type=virtual&id=\"+'+jid+'+\"&value=\"+bat;\n';
					app_rfx10 = app_rfx10+'			console.log(\"  Requete :\" + http_request);\n';
				...
				else if (proto =="ZWAVE")
				{
					...
					if (type_eqp == "power")
					{
						...
						app_zwave = app_zwave+'			http_request = \"http://'+jeedom_ip+jeedom_chemin+jeedom_api+'&type=virtual&id=\"+'+jid+'+\"&value=\" + bat;\n';
				...
				else if (proto =="oregon")
				{
					...
					app_undefined = app_undefined+'			http_request = "http://'+jeedom_ip+jeedom_chemin+jeedom_api+'&type=virtual&id=\"+'+jid+'+\"&value=\" + lev;\n';
				...
				else if (proto == "undefined")
				{
					...
					periph_jeedom = S(periph_jeedom).replaceAll('-', '').s;
						...
						jid_descr = jid_descr+'var '+jid+' = require(\'string\');\n';
						jid_file = jid_file+'\t'+jid+' = 42;\t//'+periph_jeedom+';\n';
						periph_file = periph_file+type_eqp+'\t'+periph_jeedom+'\t'+id1_eqp+'\n';
						periph_file = periph_file+type_eqp+'\t'+periph_jeedom+'\t'+id2_eqp+'\n';
						...
						app_undefined = app_undefined+'			console.log(\"  Envoi de la requete HTTP Batterie Telecommande: \" + bat);\n';
						app_undefined = app_undefined+'			request(\"http://'+jeedom_ip+jeedom_chemin+jeedom_api+'&type=virtual&id=\"+'+jid+'+\"&value=\" + bat, function(error, response, body)\n';
						app_undefined = app_undefined+'			{	console.log(new Date() + \" \" + body); });\n';
						app_undefined = app_undefined+'			nb_http_request = nb_http_request + 1;\n';*/
						app_undefined = app_undefined+'		}\n';
					}
		...
		console.log("------------------------------------------------------------------------------------")
		console.log(" Debut d'Ecriture dans le fichier zidomn8.js ...")
		fs.writeFileSync("zidomn8.js", app_script, "UTF-8");
		console.log(" Fin d'Ecriture dans le fichier zidomn8.js !")
		console.log("------------------------------------------------------------------------------------")
