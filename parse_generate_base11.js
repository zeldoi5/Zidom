...
app_script2 = app_script2+'	else  if (S(msg).include(\'Noise\')) {	noise 	= S(msg).between(\'Noise=\', \' \').s;}\n';
...
app_script2 = app_script2+'	if (S(msg).include(\'<sta>\')) {	sta 	= S(msg).between(\'<sta>\', \'</sta>\');}\n';
app_script2 = app_script2+'	else  if (S(msg).include(\'OFF\') && !S(msg).include(\'ON\')) {	sta 	= "OFF";}\n';
app_script2 = app_script2+'	else  if (!S(msg).include(\'OFF\') && !S(msg).include(\'<sta>\') && !S(msg).include(\'ON\')) {	sta 	= "ON";};\n';
...
request(xmlurl, function(err, resp, body)
{
	...
	parseString(body, function(err, result)
	{
		...
		console.log("------------------------------------------------------------------------------------")
		console.log(" Debut d'Ecriture dans le fichier zidomn11.js ...");
		fs.writeFileSync("zidomn11.js", app_script, "utf8");
		//readFileSync_encoding2("zidomn11-2.js", "UTF-8", app_script);
		//readFileSync_encoding("zidomn11-2.js", "UTF-8", app_script);
		console.log(" Fin d'Ecriture dans le fichier zidomn11.js !")
		console.log("------------------------------------------------------------------------------------")
