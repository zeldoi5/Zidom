			...
			else
			{
				...
				*/
				...
				if (proto =="CHACON")
				{
					...
					app_chacon = app_chacon+'\n		//if (chacon_id=="'+id_eqp+'_ON")\n'
					app_chacon = app_chacon+'		{\n';
					app_chacon = app_chacon+'			console.log(\" Test de l equipement ' + name_eqp + ', d\'ID '+id_eqp+' et de type '+type_eqp+'\");\n';
					app_chacon = app_chacon+'			console.log(\"  Envoi de la requete HTTP Activation de l\'equipement \");\n';
					app_chacon = app_chacon+'			request(\"http://'+jeedom_ip+jeedom_chemin+jeedom_api+'&type=virtual&id=42&value=1\", function(error, response, body)\n';
					app_chacon = app_chacon+'			{	console.log(new Date() + \" \" + body); });\n';

					app_chacon = app_chacon+'			console.log(\"  Envoi de la requete HTTP Batterie: \" + bat)\n';
					app_chacon = app_chacon+'			request(\"http://'+jeedom_ip+jeedom_chemin+jeedom_api+'&type=virtual&id=42&value=\" + bat, function(error, response, body)\n';
					app_chacon = app_chacon+'			{	console.log(new Date() + \" \" + body); });\n';
					app_chacon = app_chacon+'			http_request = http_request + 1;\n';
					app_chacon = app_chacon+'		}\n';

					app_chacon = app_chacon+'\n		if (chacon_id=="'+id_eqp+'" && chacon_status=="OFF")'
					app_chacon = app_chacon+'\n		//if (chacon_id=="'+id_eqp+'_OFF")\n'
					app_chacon = app_chacon+'		{\n';
					app_chacon = app_chacon+'			console.log(\" Test de l equipement ' + name_eqp + ', d\'ID '+id_eqp+' et de type '+type_eqp+'\");\n';
					app_chacon = app_chacon+'			console.log(\"  Envoi de la requete HTTP DESActivation de l\'equipement \");\n';
					app_chacon = app_chacon+'			request(\"http://'+jeedom_ip+jeedom_chemin+jeedom_api+'&type=virtual&id=42&value=0\", function(error, response, body)\n';
					app_chacon = app_chacon+'			{	console.log(new Date() + \" \" + body); });\n';
				...
				if (proto =="RF X10")
				{
					...
					app_rfx10 = app_rfx10+'		{\n';
					app_rfx10 = app_rfx10+'			console.log(\" Test de l equipement ' + name_eqp + ', d\'ID '+id_eqp+' et de type '+type_eqp+'\");\n';
					app_rfx10 = app_rfx10+'			console.log(\"  Envoi de la requete HTTP Activation de l\'equipement \");\n';
					app_rfx10 = app_rfx10+'			request(\"http://'+jeedom_ip+jeedom_chemin+jeedom_api+'&type=virtual&id=42&value=1\", function(error, response, body)\n';
					app_rfx10 = app_rfx10+'			{	console.log(new Date() + \" \" + body); });\n';

					app_rfx10 = app_rfx10+'			console.log(\"  Envoi de la requete HTTP Batterie: \" + bat)\n';
					app_rfx10 = app_rfx10+'			request(\"http://'+jeedom_ip+jeedom_chemin+jeedom_api+'&type=virtual&id=42&value=\" + bat, function(error, response, body)\n';
					app_rfx10 = app_rfx10+'			{	console.log(new Date() + \" \" + body); });\n';
					app_rfx10 = app_rfx10+'			http_request = http_request + 1;\n';
					app_rfx10 = app_rfx10+'		}\n';
					...
					app_rfx10 = app_rfx10+'			request(\"http://'+jeedom_ip+jeedom_chemin+jeedom_api+'&type=virtual&id=42&value=0\", function(error, response, body)\n';
					app_rfx10 = app_rfx10+'			{	console.log(new Date() + \" \" + body); });\n';
				...
				else if (proto =="ZWAVE")
				{
					if (type_eqp == "power")
					{
						...
						app_zwave = app_zwave+'\n		if (zwave_id=="'+id_eqp+'")\n'
						app_zwave = app_zwave+'		{\n';
						//app_zwave = app_zwave+'		console.log(\" Test de l equipement ' + name_eqp + ', d\'ID '+id_eqp+' et de type '+type_eqp+'\");\n';
						app_zwave = app_zwave+'			console.log(\"  Envoi de la requete HTTP Total Energy: \" + kwh)\n';
						app_zwave = app_zwave+'			request(\"http://'+jeedom_ip+jeedom_chemin+jeedom_api+'&type=virtual&id=42&value=\" + kwh, function(error, response, body)\n';
						app_zwave = app_zwave+'			{	console.log(new Date() + \" \" + body); });\n';
						app_zwave = app_zwave+'			http_request = http_request + 1;\n';

						app_zwave = app_zwave+'			console.log(\"  Envoi de la requete HTTP Power: \" + w)\n';
						app_zwave = app_zwave+'			request(\"http://'+jeedom_ip+jeedom_chemin+jeedom_api+'&type=virtual&id=42&value=\" + w, function(error, response, body)\n';
						app_zwave = app_zwave+'			{	console.log(new Date() + \" \" + body); });\n';
						app_zwave = app_zwave+'			http_request = http_request + 1;\n';

						app_zwave = app_zwave+'			console.log(\"  Envoi de la requete HTTP Batterie: \" + bat)\n';
						app_zwave = app_zwave+'			request(\"http://'+jeedom_ip+jeedom_chemin+jeedom_api+'&type=virtual&id=42&value=\" + bat, function(error, response, body)\n';
						app_zwave = app_zwave+'			{	console.log(new Date() + \" \" + body); });\n';
						app_zwave = app_zwave+'			http_request = http_request + 1;\n';
						app_zwave = app_zwave+'		}\n';
					}
					...
					if (type_eqp == "receiverXDom")
					{
						...
						app_zwave = app_zwave+'			request(\"http://'+jeedom_ip+jeedom_chemin+jeedom_api+'&type=virtual&id=42&value=1\", function(error, response, body)\n';
						app_zwave = app_zwave+'			{	console.log(new Date() + \" \" + body); });\n';
						...
						app_zwave = app_zwave+'			request(\"http://'+jeedom_ip+jeedom_chemin+jeedom_api+'&type=virtual&id=42&value=0\", function(error, response, body)\n';
						app_zwave = app_zwave+'			{	console.log(new Date() + \" \" + body); });\n';
				...
				else if (proto =="XDD868Inter/Shutter")
				{
					...
					app_xdd868intershutter = app_xdd868intershutter+'		{\n';
					app_xdd868intershutter = app_xdd868intershutter+'			console.log(\" Test de l equipement ' + name_eqp + ', d\'ID '+id_eqp+' et de type '+type_eqp+'\");\n';
					app_xdd868intershutter = app_xdd868intershutter+'			console.log(\"  Envoi de la requete HTTP Fermeture volet de l\'equipement \");\n';
					app_xdd868intershutter = app_xdd868intershutter+'			request(\"http://'+jeedom_ip+jeedom_chemin+jeedom_api+'&type=virtual&id=42&value=1\", function(error, response, body)\n';
					...
					app_xdd868intershutter = app_xdd868intershutter+'			request(\"http://'+jeedom_ip+jeedom_chemin+jeedom_api+'&type=virtual&id=42&value=0\", function(error, response, body)\n';
					app_xdd868intershutter = app_xdd868intershutter+'			{	console.log(new Date() + \" \" + body); });\n';
					app_xdd868intershutter = app_xdd868intershutter+'		}\n';
				...
				else if (proto =="XDD868PilotWire")
				{
					...
					app_xdd868pilotwire = app_xdd868pilotwire+'		{\n';
					app_xdd868pilotwire = app_xdd868pilotwire+'			console.log(\" Test de l equipement ' + name_eqp + ', d\'ID '+id_eqp+' et de type '+type_eqp+'\");\n';
					app_xdd868pilotwire = app_xdd868pilotwire+'			console.log(\"  Envoi de la requete HTTP Activation l\'equipement \");\n';
					app_xdd868pilotwire = app_xdd868pilotwire+'			request(\"http://'+jeedom_ip+jeedom_chemin+jeedom_api+'&type=virtual&id=42&value=1\", function(error, response, body)\n';
					...
					app_xdd868pilotwire = app_xdd868pilotwire+'		{\n';
					app_xdd868pilotwire = app_xdd868pilotwire+'			console.log(\" Test de l equipement ' + name_eqp + ', d\'ID '+id_eqp+' et de type '+type_eqp+'\");\n';
					app_xdd868pilotwire = app_xdd868pilotwire+'			console.log(\"  Envoi de la requete HTTP DESActication de l\'equipement \");\n';
					app_xdd868pilotwire = app_xdd868pilotwire+'			request(\"http://'+jeedom_ip+jeedom_chemin+jeedom_api+'&type=virtual&id=42&value=0\", function(error, response, body)\n';
					app_xdd868pilotwire = app_xdd868pilotwire+'			{	console.log(new Date() + \" \" + body); });\n';
					app_xdd868pilotwire = app_xdd868pilotwire+'		}\n';
				...
				else if (proto =="oregon")
				{
						...
						app_undefined = app_undefined+'			request(\"http://'+jeedom_ip+jeedom_chemin+jeedom_api+'&type=virtual&id=42&value=\" + tem, function(error, response, body)\n';
						...
						app_undefined = app_undefined+'			request(\"http://'+jeedom_ip+jeedom_chemin+jeedom_api+'&type=virtual&id=42&value=\" + lev, function(error, response, body)\n';
						app_undefined = app_undefined+'			{	console.log(new Date() + \" \" + body); });\n';
						app_undefined = app_undefined+'			http_request = http_request + 1;\n';
